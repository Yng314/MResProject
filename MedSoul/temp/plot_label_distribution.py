...
# 读取JSON文件
with open('outputs/224_10k_lp_valgt/pseudo_labels.json', 'r') as f:
    data = json.load(f)
...
ax.set_title('Distribution of Pseudo Labels (14 Labels × 4 Classes)', fontsize=14, fontweight='bold')
ax.set_xticks(x)
...
# 保存图片
plt.savefig('temp/label_distribution.png', dpi=300, bbox_inches='tight')
print("图表已保存到: temp/label_distribution.png")
