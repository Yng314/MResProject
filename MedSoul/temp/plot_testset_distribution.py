...
# 读取JSON文件
with open('outputs/test_set_2_1_0.json', 'r') as f:
    data = json.load(f)
...
ax.set_title('Distribution of Test Set Labels (14 Labels × 4 Classes)', fontsize=14, fontweight='bold')
ax.set_xticks(x)
...
# 保存图片
plt.savefig('temp/testset_label_distribution.png', dpi=300, bbox_inches='tight')
print("图表已保存到: temp/testset_label_distribution.png")
