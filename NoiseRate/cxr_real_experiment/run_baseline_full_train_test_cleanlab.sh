#!/bin/bash
#SBATCH --job-name=cxr_real_base
#SBATCH --output=slurm_logs/cxr_real_base_%j.log
#SBATCH --error=slurm_logs/cxr_real_base_%j.err
...
echo "=============================================="
echo "Real CXR Baseline Full Train + Test + Cleanlab"
echo "=============================================="
...
python -u NoiseRate/cxr_real_experiment/cxr_real_full_train_eval_cleanlab.py \
  ...
  --output-dir /vol/gpudata/yz3522-llmtest/MRes/NoiseRate/cxr_real_experiment/results_baseline_es/slurm_${SLURM_JOB_ID}
