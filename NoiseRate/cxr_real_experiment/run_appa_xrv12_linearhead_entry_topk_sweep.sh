#!/bin/bash
#SBATCH --job-name=cxr_xrv12_etopk
#SBATCH --output=slurm_logs/cxr_xrv12_etopk_%j.log
#SBATCH --error=slurm_logs/cxr_xrv12_etopk_%j.err
...
RUN_ROOT="${PROJECT_DIR}/NoiseRate/cxr_real_experiment/results_appa_xrv12_linearhead_entry_topk/slurm_${SLURM_JOB_ID}"

cd "${PROJECT_DIR}" || exit 1
mkdir -p slurm_logs "${RUN_ROOT}"

echo "=============================================================="
echo "Real CXR AP/PA XRV12 Linear-Head Entry Top-k Sweep"
echo "=============================================================="
