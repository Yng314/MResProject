#!/bin/bash
#SBATCH --job-name=cxr_appa_xrv12
#SBATCH --output=slurm_logs/cxr_appa_xrv12_%j.log
#SBATCH --error=slurm_logs/cxr_appa_xrv12_%j.err
...
VIEW_ARGS=(AP PA)
RUN_ROOT="${PROJECT_DIR}/NoiseRate/cxr_real_experiment/results_appa_xrv12_pipeline/slurm_${SLURM_JOB_ID}"
...
echo "=============================================="
echo "Real CXR AP/PA XRV12 Pipeline"
echo "=============================================="
...
common_args=(
  ...
  --learning-rate 0.001
  --num-workers 4
  --model-backbone xrv_densenet121_direct
...
out_path = run_root / "appa_xrv12_pipeline_compare.csv"
