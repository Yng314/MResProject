#!/bin/bash
#SBATCH --job-name=cxr_appa_topk
#SBATCH --output=slurm_logs/cxr_appa_topk_%j.log
#SBATCH --error=slurm_logs/cxr_appa_topk_%j.err
...
RUN_ROOT="${PROJECT_DIR}/NoiseRate/cxr_real_experiment/results_appa_densenet_topk/slurm_${SLURM_JOB_ID}"

cd "${PROJECT_DIR}" || exit 1
mkdir -p slurm_logs "${RUN_ROOT}"

echo "=============================================="
echo "Real CXR AP/PA DenseNet Top-k Sweep"
echo "=============================================="
